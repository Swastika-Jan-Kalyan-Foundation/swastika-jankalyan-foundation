            ...
            {isMobile ? (
              ...
              <>
                ...
                <div style={{ borderRadius:20, overflow:"hidden", border:"1.5px solid #c8e6c9", height:160, background:"linear-gradient(135deg,#d8f3dc,#b7e4c7)", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", position:"relative" }}>
                 ...
                 <a href="https://maps.app.goo.gl/diJNjrENrhoP7Vp68"> <span style={{ fontSize:32, marginBottom:8 }}><img className="h-12 w-12" src={gmap} /></span></a>
                 
                 <a href="https://maps.app.goo.gl/diJNjrENrhoP7Vp68" ><span style={{ color:"#52b788", fontSize:11, marginTop:4 }}>View on <span style={{color: '#1b4332'}} >Google Maps</span> →</span></a> 
                </div>
              </>
            ) : (
