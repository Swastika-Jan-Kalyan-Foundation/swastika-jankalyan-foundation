  ...
  return (
    <div className="relative bg-[#f5fdf6] overflow-x-hidden" style={{ fontFamily: "'Sora', sans-serif" }}>
      ...
      <nav className="relative z-20 flex items-center justify-between px-8 md:px-16 py-5">
        ...
        <div className=" sjkf-pill-badg hero-text mt-6 inline-flex items-center gap-2 bg-[#5FAF6B]/10 border border-[#5FAF6B]/25 rounded-full px-4 py-1.5 text-[#3d8f4a] text-[12px] font-semibold mb-6 tracking-wider uppercase">
