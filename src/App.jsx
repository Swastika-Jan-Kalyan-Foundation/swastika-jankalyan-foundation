...
<footer>
      ...
      <div className="bg-[#2d6a4f] py-4 px-6 text-center">
        <p className="text-[11px] font-bold tracking-[0.15em]  text-white mb-1 font-['DM_Sans',sans-serif]">
          REGISTERED OFFICE: 1st Floor, Opposite Durga Mandir, Lower Hatia, Near Sunday Market, Hatia, Ranchi, Jharkhand, India - 834003 .
        </p>
        <p className="text-[10px] tracking-widest uppercase text-white/60 font-['DM_Sans',sans-serif]">
